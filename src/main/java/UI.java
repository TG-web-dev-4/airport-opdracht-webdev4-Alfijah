...
public class UI {
    ...
    ArrayList<Country> matchedAirports = new DataAssembler().getMatchingAirports(dataConverter.getCountryData(), dataConverter.getAirportData());

    public UI() throws IOException {
    }

    private void getUserCountryRequest(String country, ArrayList<Country> countries, ArrayList<Airport> airports) throws IOException {
